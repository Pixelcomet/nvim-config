...
vim.keymap.set('n', '<leader>p', '<esc>i<cr><esc>O<esc>jP', {})
vim.keymap.set('n', '<leader><space>', 'O<space><esc>j', {})
vim.keymap.set('n', '<leader>es', ':set spell spelllang=en_us,de_de<CR>', {})
vim.keymap.set('n', '<leader>ds', ':setlocal nospell<CR>', {})
